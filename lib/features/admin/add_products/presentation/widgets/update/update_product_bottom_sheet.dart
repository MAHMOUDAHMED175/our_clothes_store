...
import 'package:our_clothes_store/core/common/widgets/custom_drop_down.dart';
...
import 'package:our_clothes_store/features/admin/add_products/presentation/widgets/update/update_product_images.dart';
                  ...
                  state.whenOrNull(
                    success: () {
                      context.pop();
                        showToast(
                        context: context,
                        text: '${_titleController.text} Update Success',
